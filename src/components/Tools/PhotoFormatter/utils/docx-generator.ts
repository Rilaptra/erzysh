...
export const createDocumentBody = (
  ...
  images.forEach((image, i) => {
    bodyContent += `<w:p><w:pPr><w:jc w:val="right"/></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:b/><w:sz w:val="24"/></w:rPr><w:t>${startNumber + i}.</w:t></w:r></w:p>`;
